...
class TilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tile" do
    assert_difference('Tile.count') do
      post tiles_url, params: { tile: { design_id: @tile.design_id, position: @tile.position, type: @tile.type } }, as: :json
    end
  ...
  test "should update tile" do
    patch tile_url(@tile), params: { tile: { design_id: @tile.design_id, position: @tile.position, type: @tile.type } }, as: :json
    assert_response 200
  end
